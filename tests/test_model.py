...
class TestModelHooks:
    ...
    def test_agenthook(self):
        ...
        assert results == [
            ("model driver", 0, 0),
            ("model agent1", "add", 0, 0),
            ("driver", 0, 0),
            ("monitor", 0, 0),
            ("model agent2", "add", 0, 0),
            ("model driver", 1, 1),
            ("model monitor", 0, 0),
            ("model agent1", "monitor", 0, 0),
            ("model agent1", "add", 1, 1),
            ("driver", 1, 1),
            ("monitor", 1, 1),
            ("model agent2", "add", 1, 1),
            ("model driver", 2, 2),
            ("model monitor", 1, 1),
            ("model agent1", "monitor", 1, 1),
            ("model agent1", "add", 2, 2),
            ("driver", 2, 2),
            ("monitor", 2, 2),
            ("model agent2", "add", 2, 2),
            ("model driver", 3, 3),
            ("model monitor", 2, 2),
            ("model agent1", "monitor", 2, 2),
            ("model agent1", "add", 3, 3),
            ("driver", 3, 3),
            ("monitor", 3, 3),
            ("model agent2", "add", 3, 3),
            ("model monitor", 3, 3),
            ("model agent1", "monitor", 3, 3),
        ]
