...
class TestModelHooks:
    ...
    def test_agenthook(self):
        ...
        assert results == [
            ("model driver", 0, 0),
            ("model agent1", "adder_agent.add", 0, 0),
            ("driver", 0, 0),
            ("monitor", 0, 0),
            ("model agent2", "adder_agent.add", 0, 0),
            ("model driver", 1, 1),
            ("model monitor", 0, 0),
            ("model agent1", "adder_agent.monitor", 0, 0),
            ("model agent1", "adder_agent.add", 1, 1),
            ("driver", 1, 1),
            ("monitor", 1, 1),
            ("model agent2", "adder_agent.add", 1, 1),
            ("model driver", 2, 2),
            ("model monitor", 1, 1),
            ("model agent1", "adder_agent.monitor", 1, 1),
            ("model agent1", "adder_agent.add", 2, 2),
            ("driver", 2, 2),
            ("monitor", 2, 2),
            ("model agent2", "adder_agent.add", 2, 2),
            ("model driver", 3, 3),
            ("model monitor", 2, 2),
            ("model agent1", "adder_agent.monitor", 2, 2),
            ("model agent1", "adder_agent.add", 3, 3),
            ("driver", 3, 3),
            ("monitor", 3, 3),
            ("model agent2", "adder_agent.add", 3, 3),
            ("model monitor", 3, 3),
            ("model agent1", "adder_agent.monitor", 3, 3),
        ]
